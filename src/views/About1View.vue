...
<script>
import eclat1 from '../data/eclat_1.json'
import eclat2 from '../data/eclat_2.json'
import eclat3 from '../data/eclat_3.json'
import eclat4 from '../data/eclat_4.json'
import eclat5 from '../data/eclat_5.json'
import eclat6 from '../data/eclat_6.json'
export default {
  name: 'about1View',
  data () {
    return {
